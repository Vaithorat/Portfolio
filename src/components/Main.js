...
const Main = () => {
  return (
    <div className="flex flex-col items-center md:flex-row md:justify-center md:items-center mt-10 md:mt-20">
      <div className="flex flex-col gap-4 text-white md:mr-10 md:w-1/2 sm:mx-8 px-4 sm:px-0">
  ...
  <div className="text-xl w-full md:w-3/4 font-mono text-justify">
    I am a <span className="text-green-400">Fullstack Web Developer</span> with{" "}
    <span className="text-green-400">MERN Stack</span>. Currently residing in{" "}
    <span className="text-green-400">Amravati, Maharashtra</span>. I am currently
    working as a Production Manager at{" "}
